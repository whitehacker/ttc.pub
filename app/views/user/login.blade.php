...
<div class="container" id="wrap">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form action="{{ URL::route('postLogin') }}" method="post" accept-charset="utf-8" class="form" role="form">
              <br/><br/>
              ...
              @endif
              <legend>داخل سیستم شوید <a href="{{ URL::route('postCreate') }}" class="pull-right btn btn-primary">ثبت نام نمایید!</a></legend>
<br/><br/>
                    ...
                    <input type="checkbox" name="remember" id="remember"> مرا به یاد باش!


                  {{ Form::token() }}
                    <button class="btn btn-lg btn-primary btn-block signup-btn" type="submit">
                        داخل سیستم شوید!</button>
                        <br/>
            </form>
          </div>
</div>
